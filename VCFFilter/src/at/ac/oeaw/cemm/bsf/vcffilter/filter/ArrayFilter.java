...
/** 
 * Super class of array filters. Initialized according to whether array contains
 * reference allele or is genotype array.
 * ArrayFilter.java 04 OCT 2016 
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
...
public abstract class ArrayFilter extends Filter {
    ...
    /*
     public ArrayFilter(String vcfheaderline){
     super(vcfheaderline);            
     }
     */    
    
    /**
    * Initializes new ArrayFilter.
    *
