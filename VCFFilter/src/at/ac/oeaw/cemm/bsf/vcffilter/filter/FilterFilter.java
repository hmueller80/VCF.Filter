...
/** 
 * Filters for default FILTER field (VQSRTranche).
 * FilterFilter.java 04 OCT 2016
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public class FilterFilter extends StringFilter{
    ...
    /*
    public FilterFilter(String vcfheaderline){
        super(vcfheaderline);   
    ...
    */
    ...
    /**
    * Tests if variant passes the filter given the current criteria.
    * 
    ...
    */
    ...
    /**
    * Tests if attribute matches predicate, which may contain wild card (*) character.
    * 
