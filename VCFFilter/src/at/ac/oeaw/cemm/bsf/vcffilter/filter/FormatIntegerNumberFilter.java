...
/** 
 * Filter for FORMAT fields of type Integer.
 * FormatIntegerNumberFilter.java 05 APR 2017
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public class FormatIntegerNumberFilter extends FormatNumberFilter{
    /**
    ...
    * @since 1.0
    */
    public FormatIntegerNumberFilter(VCFFormatHeaderLine header) {
        super(header);
