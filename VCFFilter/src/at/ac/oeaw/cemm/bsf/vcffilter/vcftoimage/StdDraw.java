...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    //Save FileChooser
    private static JFileChooser jFileChooser1 = new JFileChooser();
...
*/
    ...
    ***************************************************************************/
    ...
    /**
     * Event handler for JFileChooser.APPROVE_SELECTION event.
     * @param e the action event
     */
    //@Override
    public static void jFileChooser1ActionPerformed(ActionEvent e) {
        if(e.getActionCommand().equals(JFileChooser.APPROVE_SELECTION)){
            //System.out.println("file chooser fired");
