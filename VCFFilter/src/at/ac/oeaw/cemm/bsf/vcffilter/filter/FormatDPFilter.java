...
/** 
 * Filter for FORMAT field DP.
 * FormatDPFilter.java 05 APR 2017
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public class FormatDPFilter extends FormatFilter{
    /**
    ...
    /**
    * Creates new FormatDPFilter.
    * 
    * @param header VCF header line object
    * @author Heiko Müller
    * @since 1.0
    */
    public FormatDPFilter(VCFFormatHeaderLine header){
        super(header);   
        criterion1.setToolTipText(">100");
    ...
    public boolean passesFilter(VariantContext vc){
        ...
        while(it.hasNext()){
            Integer attribute = it.next().getDP();
