...
/** 
 * Filter for FORMAT fields of type String.
 * FormatStringFilter.java 05 APR 2017
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public class FormatStringFilter extends FormatFilter{
    /**
    ...
    /**
    * Creates new FormatStringFilter.
    * 
    * @param header VCF header line object
    * @author Heiko Müller
    * @since 1.0
    */
    public FormatStringFilter(VCFFormatHeaderLine header){
        super(header);   
    ...
    public boolean passesFilter(VariantContext vc){         
        ...
        while(it.hasNext()){ 
            ...
            //System.out.println("FormatStringFilter " + attribute);
