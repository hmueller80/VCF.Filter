...
/** 
 * Filter for FORMAT AD field.
 * FormatADFilter.java 05 APR 2017
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public class FormatADFilter extends FormatArrayFilter{
    /**
    ...
    /**
    * Creates new FormatADFilter.
    * 
    * @param header VCF header line object
    * @author Heiko Müller
    * @since 1.0
    */
    public FormatADFilter(VCFFormatHeaderLine header){
        super(header); 
