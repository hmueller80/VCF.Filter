...
/** 
 * abstract Filter for FORMAT fields of type Number.
 * FormatNumberFilter.java 05 APR 2017
 *
 * @author Heiko Müller
 * @version 1.0
 * @since 1.0
 */
public abstract class FormatNumberFilter extends FormatFilter{
    /**
    ...
    /**
    * Creates FormatNumberFilter.
    * 
    * @param header VCF header line object
    * @author Heiko Müller
    * @since 1.0
    */
    public FormatNumberFilter(VCFFormatHeaderLine header){
        super(header);  
